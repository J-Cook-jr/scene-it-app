                            ...
                            <div class="card w-100 h-100 d-flex flex-column">
                                ...
                                <div class="card-body d-flex flex-column justify-content-between align-items-center p-0 pt-2 m-0 overflow-auto" style="height: 27%">
                                    ...
                                    <div class="text-center d-flex justify-content-center m-0 p-2">
                                        <p class="card-text text-center border border-dark rounded p-1 font-weight-bold"><span class="bg-warning p-1 rounded font-weight-bold"><a href="https://www.imdb.com/title/${response.data.imdbID}" target="_blank">IMDb</a></span>${response.data.imdbRating}/10</p>
                                    </div>
                                </div>
